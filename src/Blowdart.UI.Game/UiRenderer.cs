...
#region Internals
		...
		private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
		{
			...
			if (drawData.TotalVtxCount > _vertexBufferSize)
			{
				...
				_vertexBuffer = new VertexBuffer(_graphicsDevice, VertexPositionTextureColor.Declaration, _vertexBufferSize, BufferUsage.None);
				_vertexData = new byte[_vertexBufferSize * VertexPositionTextureColor.Size];
			}
			...
			for (int n = 0; n < drawData.CmdListsCount; n++)
			{
				...
				fixed (void* vtxDstPtr = &_vertexData[vtxOffset * VertexPositionTextureColor.Size])
				fixed (void* idxDstPtr = &_indexData[idxOffset * sizeof(ushort)])
				{
					Buffer.MemoryCopy((void*) cmdList.VtxBuffer.Data, vtxDstPtr, _vertexData.Length, cmdList.VtxBuffer.Size * VertexPositionTextureColor.Size);
			...
			_vertexBuffer.SetData(_vertexData, 0, drawData.TotalVtxCount * VertexPositionTextureColor.Size);
